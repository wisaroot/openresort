...
window.opener.location.href="SetRateTemplate.jsp";
...
%><%@include file="ckError.jsp" %><%
       ...
       sql="insert into ratetemplate(rtp_id,rtp_descr) VALUES ( '"+ co+"','"+ des +"' )";
    ...
    <table width="60%" border="1" align="center" cellpadding="0" style=" border-color: #00F" >
        <tr>
            <td colspan="2"><div align="center" style="">
                    <div align="left"><strong>RateTemplate</strong></div>
                </div></td>
        </tr>
