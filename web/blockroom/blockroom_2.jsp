...
<%
    ...
    response.sendRedirect("blockroom.jsp?acc="+request.getParameter("acc")+"&dtl="+request.getParameter("dtl")+"&arr="+request.getParameter("arr")+"&dep="+request.getParameter("dep")+"&bt="+request.getParameter("bt")+"&qty="+request.getParameter("qty")+"&rt="+request.getParameter("rt"));
%>