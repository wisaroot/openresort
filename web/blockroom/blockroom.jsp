        ...
        <div class="content">
            ...
            <div class="row">
                ...
                <div class="span16 columns">
                    ...
                    %>
                    <!-- content here -->
                    <form class="form-stacked offset1" name="form1" method="post" action="blockroom_1.jsp" onSubmit="JavaScript:return chooseRoom();">
                        <div class="row"  >
                            ...
                            <table id="blroom">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a class="btn info" href="<%=request.getContextPath()%>/blockroom/blockroom_2.jsp?acc=<%=request.getParameter("acc")%>&dtl=<%=request.getParameter("dtl")%>&seq=<%=rs.getString(1)%>&bt=<%=request.getParameter("bt")%>&rt=<%=request.getParameter("rt")%>&arr=<%=request.getParameter("arr")%>&qty=<%=request.getParameter("qty")%>&dep=<%=request.getParameter("dep")%>" >-</a></td>
                                    </tr>
                                    <%
                                        }
                                    %>
