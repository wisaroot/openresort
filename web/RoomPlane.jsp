...
<html>
    ...
    <body><%
            ...
            try {
                ...
                rs = statement.executeQuery(" select rs_roomno,rs_statusno,rs_available from roomstatus  where rs_available > '" + startdate + "' order by rs_roomno ");
                while (rs.next()) {
                    // h = rs.getString(1);
  ...
  //      plot.getDomainAxis().setMaxCategoryLabelWidthRatio(10.0f);
        ...
        <form method="post" action="RoomPlane1.jsp">
            <table>
                <tr><td>Room No</td><td colspan="3" ><input type="text" name="s"/><input type="submit" name="submit" value="Search"/></td>
                   </tr>
                ...
                <tr>   <td> <p style=" color:red " >Occupied </p> </td>
                 <td> <p style=" color:black " >Out Of Order </p> </td>
                  <td> <p style=" color:blue " >Vacant Dirty </p> </td>
                   <td> <p style=" color:yellow " >Vacant Clean </p> </td></tr>
