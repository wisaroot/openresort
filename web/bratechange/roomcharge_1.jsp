...
<%
    ...
    String selectBRateChangeSQL = "SELECT brc_room, brc_service, brc_tax, brc_extrabed, brc_extbedserv, brc_extbedtax, brc_discount, brc_abf, brc_lunch, brc_dinner,(brc_room+brc_service+brc_tax+brc_extrabed+brc_extbedserv+brc_extbedtax-brc_discount+brc_abf+brc_lunch+brc_dinner)as brc_total, brc_seq, brc_chgdate FROM bratechange where brc_chgdate=? and brc_accno=? and brc_seq=?;";
    ...
    try {
        ...
        preparedStatementSelect.setInt(3,Converter.parseInt(seq));
        ResultSet rs = preparedStatementSelect.executeQuery();
         ...
         while (rs.next()) {
            ...
            obj.put("seq", rs.getString(12));
            obj.put("chgDate", rs.getString(13));
            out.print(obj);
            out.flush();
        }
