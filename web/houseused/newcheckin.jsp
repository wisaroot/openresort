...
<html>
    ...
    <body>
                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                <div class="span6">
                                    ...
                                    <script type="text/javascript">
                                        function getRoom(acc,dtl,arr,dep){
                                            $.ajax( 'getroom.jsp?acc='+acc+'&dtl='+dtl+'&arr='+arr+'&dep='+dep ).done(function(data) { 
                                        ...
                                        <div class="input">
                                            <div class="inline-inputs">
                                                <input type="text" name="arrival" id="arrival"
                                                       class="span2" onchange="getRoom(acc.value,dtl.value,arrival.value,departure.value)" value="<%=request.getParameter("arr")%>"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="clearfix">
                                        ...
                                        <div class="input">
                                            <div class="inline-inputs">
                                                <input type="text" name="departure" id="departure"
                                                       class="span2" onchange="getRoom(acc.value,dtl.value,arrival.value,departure.value)" value="<%=request.getParameter("dep")%>" /> 
                                            </div>
                                        </div>
                                    </div>
                                    <div class="clearfix">
                                    ...
                                    <div class="clearfix">
                                        ...
                                        <div class="input">
                                            <input type="text" name="roomNo" id="roomNo" class="span2" value="<%
                                                    preparedStatementSelect = dbConnection.prepareStatement("SELECT bl_roomno FROM block WHERE bl_accno=? and bl_dtlseq=? and bl_arrdate=? and bl_depdate=?;");
        ...
        preparedStatementSelect.setDate(4, Converter.parseSQLDate(request.getParameter("dep")));
                                                ...
                                                %>"/>
                                            <button class="btn info"  onclick="window.open('blockroom.jsp?acc='+acc.value+'&qty=1&bt='+bedType.value+'&rt='+roomType.value+'&arr='+arrival.value+'&dep='+departure.value+'&dtl='+dtl.value, '_blank', 'height=700, width=1000');return false;">...</button>
                                        </div>
                                    </div>
                                    <div class="clearfix">
                                        <label>Rate</label>
                                        <div class="input">
                                            <div class="inline-inputs">
                                                <input type="text" name="rateCode" id="rateCode" class="span2" value="COM" readonly="true"/>
