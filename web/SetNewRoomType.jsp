...
<SCRIPT TYPE="text/javascript">
    function submitAndClose() {
        window.opener.location.href="SetRoomType.jsp";
...
<body>
    <%
                ...
                if (MultipartFormDataRequest.isMultipartFormData(request)) {
                    ...
                    String mz1 = mrequest.getParameter("max");
                    String max = new String(mz1.getBytes("ISO8859_1"), "utf-8");
    ...
    %><%@include file="ckError.jsp" %><% } else {
                            ...
                            sql = "insert into roomtype (rt_Id,rt_descr,rt_grp,rt_max) VALUES ( '" + co + "','" + des + "','" + group + "','" + max + "' )";
        ...
        <table width="60%" border="1" align="center" cellpadding="0" style=" border-color: #00F" >
            <tr>
                <td colspan="2"><div align="center" style="">
                        <div align="left"><strong>RoomType</strong></div>
                    </div></td>
            </tr>
