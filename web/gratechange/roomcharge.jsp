...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function loadRoomChargeSchedule(rd,acc){
                $.getJSON('roomcharge_1.jsp?bd='+rd+'&acc='+acc, function(data) {
            ...
            %>
                    ...
                    $('#days').bind('click',function(){
                        if(!isFirst){
                            ...
                            $('#cDate').html(key);
                            $('#chgDate').val(key);
                            loadRoomChargeSchedule(key,'<%=acc%>');
                            ...
                            <div class="span5 columns">
                                <div class="alert-message block-message info">
                                    ...
                                    <div class="clearfix">
                                        ...
                                        <div class="input">
                                            <input type="text" name="rateCode" value="<%=(request.getParameter("rc")==null?"OPN":request.getParameter("rc"))%>"
