...
window.opener.location.href="SetRoomStatus.jsp";
...
String status1=mrequest.getParameter("status");
String status = new String(status1.getBytes("ISO8859_1"),"utf-8");
...
%><%@include file="ckError.jsp" %><%
       ...
       sql="insert into status (rs_id,rs_descr,rs_status) VALUES ( '"+ co+"','"+ des +"','"+ status +"' )";
    ...
    <table width="60%" border="1" align="center" cellpadding="0" style=" border-color: #00F" >
        <tr>
            <td colspan="2"><div align="center" style="">
                    <div align="left"><strong>RoomSattus</strong></div>
                </div></td>
        </tr>
