                            ...
                            <table>
                                ...
                                <tbody>
                                    <%String bkacc = request.getParameter("bkacc");
                                        ...
                                        preparedStatementSelect = dbConnection.prepareStatement("SELECT   grequire.gr_accno,   grequire.gr_reqno,   requirement.\"name\",   grequire.gr_fromdate,   grequire.gr_eventtime,   grequire.gr_enddate,   grequire.gr_chargeflag,   grequire.gr_deptno,   department.d_name,   grequire.gr_amount,   grequire.gr_chargetype,   grequire.gr_remark FROM   public.grequire,   public.requirement,   public.department WHERE   grequire.gr_reqno = requirement.rq_reqno AND  grequire.gr_deptno = department.d_id AND gr_accno=?;");
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="newrequirementnote_2.jsp?req=<%=rs.getString(2)%>&from=<%=rs.getString(4)%>&acc=<%=rs.getString(1)%>&bkacc=<%=bkacc%>" class="btn info">-</a></td>
                                    </tr>
                                    <%
                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                <div class="span15 offset1">
                                    ...
                                    <div class="clearfix">
                                        <label><span>Charge ?</span> </label>
                                       
                                          
                                        <div class="input">
                                          
                                            <input type="checkbox"  name="charge" id="charge" value="Y" checked="checked" />
                                    ...
                                    <div class="clearfix">
                                        ...
                                        <div class="input">
                                            <textarea name="note" rows="3" id="note" class="span6"><%
                                                preparedStatementSelect = dbConnection.prepareStatement("SELECT gn_note FROM gnote where gn_accno=?;");
                                                preparedStatementSelect.setInt(1, Converter.parseInt(request.getParameter("acc")));
                            ...
                            <div class="actions">
                                <input type="submit" class="btn primary" value="Save New Requirement" />
                                  <input type="hidden" name="bkacc" value="<%=(String) request.getParameter("bkacc")%>"/>
                                     
                               <input type=button onClick="location.href='../checkin/CheckinSeq.jsp?acc=<%=guest.getAccountId()%>&bkacc=<%=bkacc%>&dtl=0&seq=0'" class="btn primary" value='Close'/>
