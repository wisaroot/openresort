...
<html>
    ...
    <body>
        <%
            ...
            InputStream reportStream = getServletConfig().getServletContext().getResourceAsStream("/report/GuestInfoReport.jasper");
            InputStream jasperSubReport = getServletConfig().getServletContext().getResourceAsStream("/report/GuestInfoReport_sub.jasper");
            ...
            parameters.put("GuestInfo", subreport1_jasper);
