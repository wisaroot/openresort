...
<html>
    ...
    <%
 String dateInput = request.getParameter("fol");
        ServletOutputStream servletOutputStream = response.getOutputStream();
        InputStream reportStream = getServletConfig().getServletContext().getResourceAsStream("/report/CityLedger.jasper");
        InputStream jasperSubReport = getServletConfig().getServletContext().getResourceAsStream("/report/CityLedger_sub1.jasper");



        JasperReport subreport1_jasper = (JasperReport) JRLoader.loadObject(jasperSubReport);
int aa = Integer.parseInt(dateInput);
       
        Map parameters = new HashMap();
        //parameters.put("Dateinput2", dateInput);
        parameters.put("fol", aa);
        parameters.put("citysub", subreport1_jasper);
