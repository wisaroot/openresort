...
<html>
 ...
 String dateInput = request.getParameter("fol");
        ...
        InputStream reportStream = getServletConfig().getServletContext().getResourceAsStream("/report/Guestledgerfolio.jasper");
        InputStream jasperSubReport = getServletConfig().getServletContext().getResourceAsStream("/report/Guestledgerfolio_sub.jasper");
