    ...
    <script language="JavaScript">
        function updateOpener() {
            ...
            window.opener.document.frmMain.txtroom1.value = document.all.nz2.value;
             window.opener.document.frmMain.folno.value = document.all.nz3.value;
            window.close();
        }
    </script>
     ...
     <%
      ...
      try {
        ...
        try {
            ...
            String QueryString = " select  RTRIM(gf_roomno) ,RTRIM(gn_fname),gf_folno from gaccount  left join  guestname on (guestname.gn_guestno= gaccount.ga_guestno ) left join GFOLIO on(gaccount.ga_accno= gfolio.gf_accno) where  gaccount.ga_accstat = 'I' and gf_roomno is not null order by gf_roomno";
