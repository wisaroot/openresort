...
window.opener.location.href="SetReservationType.jsp";
...
%><%@include file="ckError.jsp" %><%
       ...
       sql="insert into reservationtype(Rst_Id,Rst_Descr) VALUES ( '"+ co+"','"+ des +"' )";
    ...
    <table width="60%" border="1" align="center" cellpadding="0" style=" border-color: #00F" >
        <tr>
            <td colspan="2"><div align="center" style="">
                    <div align="left"><strong>ReservationType</strong></div>
                </div></td>
        </tr>
