...
<%@ include file ="../config.jsp"%> 
 <%  
  Connection connect = null;
            ...
            ResultSet rs = null;
 String origin=request.getParameter("count");  
 String buffer="<select name='agent'><option value='-1'>Select</option>";  
 try {
  ...
  rs = statement.executeQuery("SELECT a_id, a_name FROM agent where o_id='"+origin+"' ");  
   while(rs.next()){
