...
<body>
    ...
    <script language="JavaScript">
        function updateOpener() {
            ...
            window.opener.document.test.txtroom.value = document.all.nz1.value;
            window.opener.document.test.txtroom1.value = document.all.nz2.value;
            window.close();
        }
    </script>
     ...
     <%
      ...
      try {
        ...
        try {
            ...
            String QueryString = " select  gf_folno,RTRIM(gf_roomno),RTRIM(gn_fname)   from gaccount  left join  guestname on (guestname.gn_guestno= gaccount.ga_guestno ) left join GFOLIO on(gaccount.ga_accno= gfolio.gf_accno) where  gaccount.ga_accstat = 'I' and gf_roomno is not null order by gf_roomno";
            ...
            out.println("<tr id='tbl' bgColor=#8080a6 ><td>Select</td><td>Fol </td><td>Room </td><td>Name </td></tr>");
...
//out.println("<input type='hidden' name='mz1' value=" + rs.getString(2)+" >");
                out.println("<TR  ><TD><input type='checkbox'  name='nz'  value='" + s + "' onclick='CheckOne(this)'   /> </TD><TD>" + rs.getString(1) + "</TD><TD>" + rs.getString(2) + "</TD><TD>" + rs.getString(3) + "</TD>");
            ...
            out.println("<TR  > <td colspan='4'><div align='center'><input name='Close'  type='submit' id='Close'  value='Submit'/></td></TR>");
