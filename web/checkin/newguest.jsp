                ...
                <div class="span16 columns">
                    ...
                    <%
                        ...
                        try {
                            ...
                            preparedStatementSelect.setInt(1, Integer.parseInt(request.getParameter("bkacc")));
                            preparedStatementSelect.setInt(2, Integer.parseInt(request.getParameter("dtl")));
                            ResultSet rs = preparedStatementSelect.executeQuery();

                            while (rs.next()) {
                                arrdate = rs.getString("b_arrdate");
                                depdate = rs.getString("b_depdate");
                            }
...
%>
                    <form  method="post" action="newguest_1.jsp">
                        <fieldset>
                            ...
                            <div class="clearfix">
                                <label>&nbsp;</label>
                                <div class="inline-inputs">
                                    Arrival Date <input type="text" class="span2" name="arrival" id="arrival" value="<%=arrdate%>"/> &nbsp; 
                            ...
                            <div class="clearfix">
                                <label>&nbsp;</label>
                                <div class="inline-inputs">
                                    Departure Date <input type="text" class="span2" name="departure" id="departure" value="<%=depdate%>"/> &nbsp; 
                        ...
                        <div class="actions"> <input type="hidden" name="bkacc" value="<%=(String) request.getParameter("bkacc")%>"/>
                            <input type="hidden" name="seq" value="<%=(String) request.getParameter("seq")%>"/>
                            <input type="submit" value="Next" class="btn primary offset-two-thirds" /></div>
                    </form>
                </div>
            </div>
        </div>
