...
window.opener.location.href="SetNationality.jsp";
...
String mz1=mrequest.getParameter("mzz");
...
%><%@include file="ckError.jsp" %><%
       ...
       sql="insert into nationality (n_Id,n_Descr,n_mz) VALUES ( '"+ co+"','"+ des +"','"+ mz +"' )";
    ...
    <table width="60%" border="1" align="center" cellpadding="0" style=" border-color: #00F" >
        <tr>
            <td colspan="2"><div align="center" style="">
                    <div align="left"><strong>Nationality</strong></div>
                </div></td>
        </tr>
        ...
        <tr>
           ...
           <tr> <td width="25%">Marketzone</td>
                <td width="75%">
                    <select name="mzz" id="Txt-Field" onchange="id.value=this.value; name.value=this.options[selectedIndex].text;">
                        ...
                        <option value="<%=j1%>"name="mzz" ><%=j2%></option>
