        ...
        <script type="text/javascript">
            jQuery(document).ready(function(){
                ...
                jQuery("#list10_d").jqGrid({
                    url:'GuestHistoryDb.jsp?id=0',
                    datatype: 'json',
                    colNames:['GuestNo','GaccNo','Name/Last','Nationality','VipNo','Block'],
                    ...
                    colModel:[
                        ...
                        {name:'GuestNo',index:0,width:250,align:"center" },
                        {name:'GaccNo',index:1,align:"center"}, 
                        {name:'Name/Last',index:2,align:"center"},                     
                        {name:'Nationality',index:3,align:"center"},
                        {name:'VipNo',index:4,align:"center" },                      
                        {name:'TelNo',index:5,align:"center"},
                    ...
                    ondblClickRow: function(id, rowid) { 
                        ...
                        var myCellData = $('#list10_d'). 
                            jqGrid('getCell', $('#list10_d').jqGrid('getGridParam', 'selrow'), 'GuestNo'); 
                        var url = "GuestHistoryDetail.jsp?id="+myCellData+""; 
                        // alert(myCellData);
