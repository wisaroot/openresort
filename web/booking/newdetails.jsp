                            ...
                            <div class="row">
                                <div class="span6">
                                    ...
                                    <div class="clearfix">
                                        ...
                                        <div class="input">
                                            <button class="btn info"  onclick="window.open('../blockroom/blockroom.jsp?acc='+acc.value+'&bt='+bedType.value+'&rt='+roomType.value+'&arr='+arrival.value+'&qty='+qty.value+'&dep='+departure.value+'&dtl='+dtl.value, '_blank', 'height=700, width=1000');return false;">...</button>
                                        </div>
                                    </div>
                                    <div class="clearfix">
                                        <label>Rate</label>
