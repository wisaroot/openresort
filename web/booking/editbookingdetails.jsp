...
<html>
    ...
    <%@ include file="editbookingdetails_1.jsp" %>
    <body>
        <div class="content">
                ...
                <div class="span16 columns">
                   ...
                   //     List<String> errorList = (ArrayList<String>) session.getAttribute("errors" + session.getId());
                    ...
                    <%
                        ...
                        errorList = new ArrayList<String>();
                        session.setAttribute("errors" + session.getId(), errorList);
                        BookingDetails bookingDetails = getBookingDetails(user1, pw, url, driver,(String) request.getParameter("acc"), (String) request.getParameter("dtl"), errorList);
                    ...
                    %>
                    <!-- content here -->
                    <form  method="post" action="editbookingdetails_2.jsp" onsubmit="return validate()">
                        <fieldset>
                            ...
                            <div class="row">
                                <div class="span6">
                                    ...
                                    <%
                                        ...
                                        preparedStatementSelect = dbConnection.prepareStatement("SELECT (select a_name from agent where a_id=(select ga_agentno from gaccount where ga_accno=?)) as a_name ,allotment.am_id,   allotment.am_dstart,   allotment.am_dend,   allotment.am_qty,   allotment.cutoff1 FROM   public.allotment WHERE   ag_id = (select ga_agentno from gaccount where ga_accno=?) AND   am_dstart <= ? AND (am_dend-cutoff1) >= ? ;");
                                        preparedStatementSelect.setInt(1, Converter.parseInt(bookingDetails.getAccountId()));
                                        preparedStatementSelect.setInt(2, Converter.parseInt(bookingDetails.getAccountId()));
                                        preparedStatementSelect.setDate(3, Converter.parseSQLDate(bookingDetails.getArrival()));
                                        preparedStatementSelect.setDate(4, Converter.parseSQLDate(bookingDetails.getDeparture()));
                                        ...
                                        <div class="input">
                                            <div class="inline-inputs">
                                                <input type="text" name="qty"
                                                       class="span1" value="<%=bookingDetails.getQty()%>"/>&nbsp;
                                    ...
                                    <input type="hidden"  name="acc" value="<%=bookingDetails.getAccountId()%>"/>
                                    ...
                                    <div class="clearfix">
                                        ...
                                        <div class="input">
                                            <button class="btn info"  onclick="window.open('../blockroom/blockroom.jsp?acc='+acc.value+'&bt='+bedType.value+'&rt='+roomType.value+'&arr='+arrival.value+'&dep='+departure.value+'&qty='+qty.value+'&seq=0&dtl='+dtl.value,'_blank', 'height=700, width=1000');return false;">...</button>
                                        </div>
                                    </div>
                                    <div class="clearfix">
                                        <label>Rate</label>
                                    ...
                                    <div class="clearfix">
                                        ...
                                        <div class="input">
                                            <select name="chargeTo" class="span3"><option value="B" <%=(bookingDetails.getChargeTo().equalsIgnoreCase("B") ? "selected=\"selected\"" : "")%>>Booking Account</option><option value="O" <%=(bookingDetails.getChargeTo().equalsIgnoreCase("O") ? "selected=\"selected\"" : "")%>>Own Account</option></select>
                                        </div>
                                    </div>
                            ...
                            %>
                         <div class="input">
                                            <button class="btn info"  onclick="window.open('../faces/report/RegisterCard.jsp?acc='+acc.value,'_blank', 'height=700, width=1000');return false;">PrintRegisterCards </button>
                                        </div>
                        </fieldset>
                        <div class="actions">
                           
                             <input type="submit" value="Save" class="btn primary offset-two-thirds"/> 
                        </div>
                    </form>
                    <script type="text/javascript">
