...
<%!
    public BookingDetails getBookingDetails(String user1,String pw,String url,String driver,String accountId,String dtl, List errorList)throws SQLException,Exception {
