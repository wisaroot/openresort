...
<html>
    ...
    <%@ include file="editgrguest_1.jsp" %>
    <body>
        <div class="content">
...
%>
                    <form  method="post" action="editgrguest_2.jsp">
                        <fieldset>
                            ...
                            <div class="clearfix">
                                ...
                                <div class="inline-inputs">
                                    ...
                                    Birthdate <input type="text" class="span2" name="birthDate" id="birthDate" value="<%=guest.getBirthDate()%>"/> &nbsp; 
                            ...
                            <div class="clearfix">
                                <label>&nbsp;</label>
                                <div class="inline-inputs">
                                    Arrival Date <input type="text" class="span2" name="arrival" id="arrival" value="<%=guest.getArrival()%>"/> &nbsp; 
                            ...
                            <div class="clearfix">
                                <label>&nbsp;</label>
                                <div class="inline-inputs">
                                    Departure Date <input type="text" class="span2" name="departure" id="departure" value="<%=guest.getDeparture()%>"/> &nbsp; 
