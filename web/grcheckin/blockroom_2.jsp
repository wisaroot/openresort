...
<%
    ...
    String deleteNameListSQL = "update namelist set nl_roomno=null where nl_accno=? and nl_dtlseq=? and nl_seq=? ";
    ...
    try {
        ...
        preparedStatementDelete.executeUpdate();
         ...
         preparedStatementDelete = dbConnection.prepareStatement(deleteNameListSQL);
        preparedStatementDelete.setInt(1, Converter.parseInt(accountId));
        preparedStatementDelete.setInt(2, Converter.parseInt(dtl));
        preparedStatementDelete.setInt(3, Converter.parseInt(seq));
        preparedStatementDelete.executeUpdate();
    ...
    response.sendRedirect("blockroom.jsp?acc="+request.getParameter("acc")+"&dtl="+request.getParameter("dtl")+"&arr="+request.getParameter("arr")+"&dep="+request.getParameter("dep")+"&bt="+request.getParameter("bt")+"&seq="+request.getParameter("seq")+"&rt="+request.getParameter("rt"));
%>