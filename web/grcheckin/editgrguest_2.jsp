...
<%!
    ...
    private boolean saveGuest(String user1,String pw,String url,String driver,Guest guest,WebUser user, List errorList) throws SQLException {
        ...
        try {
            ...
            //ga_agentno,
            preparedStatementInsert.setInt(7,Converter.parseInt(guest.getAgent()));
            //ga_orino,
            preparedStatementInsert.setString(8,guest.getOrigin());
            //ga_arrival,
            preparedStatementInsert.setDate(9,Converter.parseSQLDate(guest.getArrival()));
            //ga_arrtime,
            preparedStatementInsert.setTime(10,Converter.parseSQLTime(guest.getArrTime()));
            //ga_arrfrom, 
            preparedStatementInsert.setString(11,guest.getArrFrom());
            //ga_arrby, 
            preparedStatementInsert.setString(12,guest.getArrBy());
            //ga_departure, 
            preparedStatementInsert.setDate(13,Converter.parseSQLDate(guest.getDeparture()));
            //ga_deptime, 
            preparedStatementInsert.setTime(14,Converter.parseSQLTime(guest.getDepTime()));
            //ga_depto,
            preparedStatementInsert.setString(15,guest.getDepTo());
            //ga_depby,
            preparedStatementInsert.setString(16,guest.getDepBy());
            //ga_fpatno,
            preparedStatementInsert.setString(17,guest.getFollioPattern());
            //ga_recdate,
            preparedStatementInsert.setDate(18,Converter.parseSQLDate(Converter.getCurrentDate()));
            //ga_userno,
            preparedStatementInsert.setString(19,user.getUsername());
            //ga_coa
            preparedStatementInsert.setString(20,Converter.parseToYesNo(guest.getCoa()));
            preparedStatementInsert.setInt(21,Converter.parseInt(guest.getAccountId()));
            preparedStatementInsert.executeUpdate();
...
<%
    ...
    if (errorList.size() > 0) {
        ...
        response.sendRedirect("editgrguest.jsp?acc="+guest.getAccountId());
    } else {
        if (saveGuest(user1, pw, url, driver ,guest,user, errorList)) {
