...
//url, user1, pw
                    ...
                    %>
                    <!-- content here -->
                    <form class="form-stacked offset1" name="frmMain"  method="post" action="blockroom_1.jsp" onsubmit="chooseRoom()">
                        <div class="row"  >
                                        ...
                                        <select class="span3" id="room" name="room" onclick="getRoom1(this.value)" width="250" style="width: 250px"> 
                                            <%
                                                String sql = "select ri_room,ri_location from roominfo where ri_room not in "
                                                        ...
                                                        + "    or ro_start between '" + (String) request.getParameter("arr") + "' and '" + dep + "' ) and (ri_type='" + rt + "') and (ri_bedtype='" + bt + "')  order by ri_room asc ";
                          ...
                          <script>
                                function getRoom1(str){
                                  ...
                                  if (lo=="none" ){
                                        ...
                                        location.href = 'chblockroom.jsp?acc='+acc+'&bt='+bt+'&rt='+rt+'&arr='+arr+'&dep='+dep+'&dtl='+dtl+'&seq='+seq+'';
                            ...
                            <div class="span1">
                                <div class="clearfix">
                                    ...
                                    <div class="input">
                                        ...
                                        <input type="hidden" name="acc" id="acc" value="<%=(String) request.getParameter("acc")%>"/>
