...
public class Guest {
    ...
    private String depBy=DefaultValue.DUMMY;
     private String voucher=DefaultValue.DUMMY;
...
public String getVoucher() {
    ...
    public void setVoucher(String voucher) {
        if(voucher==null)
            this.voucher=DefaultValue.DUMMY;
        else
    ...
    public Guest(String accountId, String confidential, String coa, String vip, String reserveBy, String follioPattern, String title, 
            String last, 
            String first, 
            String middle, 
            String sex, 
